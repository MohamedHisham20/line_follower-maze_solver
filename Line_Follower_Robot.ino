...
int sensor2 = 11;
int sensor3 = 12;      // Right most sensor
...
void read_sensor_values()
{
  ...
  if ((sensor[0] == 1) && (sensor[1] == 0) && (sensor[2] == 0))
    ...
    error = -3;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 0)) // Turn robot left side
    error = 100;
  else if ((sensor[0] == 0) && (sensor[1] == 1) && (sensor[2] == 1)) // Turn robot right side
    error = 101;
